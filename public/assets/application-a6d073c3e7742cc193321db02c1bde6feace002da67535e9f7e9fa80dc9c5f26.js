...
jQuery(document).ready(function ($) {
    ...
    slide.waypoint(function (event, direction) {
        ...
        if (direction === 'down') {
            $('.nav-pills li[data-slide="' + dataslide + '"]').addClass('active').prev().removeClass('active');
        }
        // else If the user scrolls down change the navigation link that has the same data-slide attribute as the slide to active and
        //remove the active class from the next navigation link
        else {
            $('.nav-pills li[data-slide="' + dataslide + '"]').addClass('active').next().removeClass('active');
        }
    });
    ...
    mywindow.scroll(function () {
        if (mywindow.scrollTop() == 0) {
            $('.nav-pills li[data-slide="1"]').addClass('active');
            $('.nav-pills li[data-slide="2"]').removeClass('active');
        }
    });
